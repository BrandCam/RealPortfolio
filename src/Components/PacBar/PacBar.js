...
import PacWrap from "./PacBar.style";
import ghost from "../../img/ghost.svg";
const PacBar = ({ dots, select }) => {
  let [pacPos, setPacPos] = useState(0);
        ...
        <React.Fragment key={i}>
          ...
          <label onClick={() => changeHandel(i)} for={`dot-${i + 1}`}>
            ...
            >
              ...
              >
                <path
                  d="M6020 11379 c-1513 -119 -2872 -887 -3751 -2119 -561 -786 -874
